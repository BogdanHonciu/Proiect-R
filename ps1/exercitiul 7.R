...
#  f este o functie densitate de probabilitate (pdf)
#  p este un string ce reprezinta probabilitatea (conditionata sau independenta).
#  var se va afla in stanga operatorului
