...
# verificam daca functia de densitate este valida
# trebuie sa fie pozitiva
# probabilitatea totala trebuie sa fie 1, inseamna ca sigur se intampla ceva
verificare_densitate <- function(f, a, b) {
...
# pentru repartitiile standard carora le stim functia de repartitie
...
# pentru repartitiile carora nu le stim functia de repartitie
# ne folosim de pdf
# afisaza graficul repartitiei
...
# marcheaza daca vrem graficul densitatii, sau al repartitiei si parametrii corespunzatori repartitiei selectate
