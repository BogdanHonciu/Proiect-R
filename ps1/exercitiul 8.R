...
data_aux$add("Utilizari", R6Class(public = list(print = "Poate fi observata in ziua de zi cu zi. De exempul distributia notelor unor studenti la un examen")))
...
data_aux$add("Utilizari", R6Class(public = list(print = "Distributia Cauchy este folosita des in analiza distributiei observatiilor facute de catre oameni de stiinta despre despre obiecte care se invart.")))
